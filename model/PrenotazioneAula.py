class PrenotazioneAula:
    def __init__(self, data_prenotazione, ID, data_effettuazione, ora_inizio, ora_fine, ora_attivazione, disponibilita, codice_aula):
    ...
    def get_codice_aula(self):
        return self.codice_aula

    # Setter per la proprietà 'codice_aula'
    def set_codice_aula(self, codice_aula):
        self.codice_aula = codice_aula

    def stampa(self):
        print(self.data_prenotazione, self.ID, self.data_effettuazione, self.ora_inizio, self.ora_fine, self.ora_attivazione, self.disponibilita, self.codice_aula)
